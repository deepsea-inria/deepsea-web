...
make opt && prun output.opt -test real_lifo -seq list_ref,vector,pchunked_stack_ref_256,chunked_stack_256,sized_array -n 20000000 -length 100,1000,10000,100000,1000000,10000000 -runs 3
...
make opt && prun output.opt -test real_string_buffer -seq stdlib_buffer,pchunked_string_4096 -n 500000000 -max_word_length 10,20,50,500,5000 -length 500000000 -runs 3
...
make opt && prun output.opt -test lifo_1 -seq list_ref,vector,chunked_stack,circular_array,sized_array -n 20000000 -length 1000000  -static_array_size 2000000 -gc_major 0,1 -runs 3
...
make opt && prun output.opt -test real_lifo,lifo_1 -seq list_ref,vector,chunked_stack,circular_array,sized_array -n 20000000 -length 10,100,1000,10000,100000,1000000,10000000 -runs 3
...
make out opt && prun output.out,output.opt -test lifo_1 -seq list_ref,vector,chunked_stack,circular_array,sized_array -n 20000000 -length 10000000 -runs 5
...
make dbg && prun output.dbg -test lifo_debug_1 -seq sized_array,vector,circular_array,list_ref,chunked_stack
